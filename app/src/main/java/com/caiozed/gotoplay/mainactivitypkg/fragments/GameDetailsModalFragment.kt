...
class GameDetailsModalFragment(var game: Game, var parentViewModel: GameDetailsViewModel) : BottomSheetBehavior<View>() {
...
//            dialog.findViewById<View>(R.id.touch_outside).setOnClickListener {}//Disable click outside dismiss
...
//        parentViewModel.view.finishAfterTransition()
